...
class Authentication
{
    ...
    {
        //this function will trigger when the class is called
    ...
    public function signup( $email = '', $password = '', $confirm_password = '' )
    {
        ...
        //ensure the password matches the confirm password
        if(
            !empty($password) && !empty($confirm_password) && $password !== $confirm_password
        ) {
